...
<footer id="colophon" class="row site-footer" role="contentinfo">
   ...
   <div class="clip_frame grpelem " id="u504"><!-- image -->
    ...
    <a class="nonblock nontext MuseLinkActive clip_frame grpelem" id="u524" href="<?php echo esc_url( home_url()); ?>/inicio"><!-- image -->
        <img class="block" id="u524_img" src="<?php echo(get_template_directory_uri()); ?>/images/mensaje-de-los-angeles-y-mensajes-espirituales-anami-logo-anami-footer.png?crc=64926581" alt="" width="221" height="85"/>
    </a>
   ...
   <div class="clearfix grpelem" id="pu1858-4"><!-- column -->
    ...
    <div class="clearfix grpelem" id="pu547"><!-- column -->
        ...
        <a class="nonblock nontext MuseLinkActive clearfix colelem" id="u1861-8" href="<?php echo esc_url( home_url()); ?>/inicio"><!-- content -->
            <p><span id="u1861">© <?php echo date('Y'); ?></span> Todos los derechos reservados,</p><p><span id="u1861-4">Anamí</span>, Medellín - Colombia.</p>
        </a>
    </div>

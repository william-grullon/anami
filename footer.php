...
Muse.Utils.initWidget('.MenuBar', ['#bp_infinity', '#bp_900', '#bp_735'], function(elem) { return $(elem).museMenu(); });/* unifiedNavBar */
Muse.Utils.initWidget('#accordionu5943', ['#bp_735'], function(elem) { return new WebPro.Widget.Accordion(elem, {canCloseAll:true,defaultIndex:-1}); });/* #accordionu5943 */
